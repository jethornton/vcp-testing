...
"""Main entry point for vcp_testing.
...
Example:
    ...
    launch vcp_testing by saying::

        $ vcp_testing --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='vcp_testing',
                          vcp_name='vcp_testing',
